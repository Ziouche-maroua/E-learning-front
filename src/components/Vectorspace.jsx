...
const VS = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-4 mb-8">
      <h1 className="text-3xl font-bold mb-8 mt-4">Vector Space Visualization</h1>
      <svg ref={svgRef} className="border border-gray-300 mt-5"></svg>
      <div className="max-w-3xl text-left mt-5 font-sans">
        {/* Content */}
        <h2 className="text-2xl poetsen-font mt-4 mb-4">Definition</h2>
        <p className=" leading-relaxed font-bold mt-2">
        ...
        <h2 className="text-2xl poetsen-font  mb-4 mt-4">Internal Law (Vector Addition)</h2>
        {/* Other content... */}
        ...
        <h2 className="text-2xl poetsen-font  mb-4 mt-4">External Law (Scalar Multiplication)</h2>
