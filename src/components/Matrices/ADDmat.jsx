    ...
    return (
        <div className="flex flex-col justify-center items-center mt-10 space-y-4">
            ...
            <p className="text-center mb-4">
                To add two matrices, the matrices have to be of the same size. The addition works by simply adding corresponding entries of the matrices.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-6 sm:space-y-0 space-y-6">
                ...
                <div className="flex items-center text-2xl sm:hidden">+</div>
                <div className="text-center sm:w-1/3">
