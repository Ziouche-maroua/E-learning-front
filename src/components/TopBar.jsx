...
const TopBar = () => {
  ...
  const [isLargeScreen, setIsLargeScreen] = useState(window.innerWidth > 768); // Define large screen as width > 768px
  ...
  return (
    <div className="fixed top-0 w-full h-16 bg-blue-500 flex justify-between items-center px-4">
      ...
      {isLargeScreen && ( // Only show search bar on large screens
