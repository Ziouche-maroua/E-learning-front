            ...
            {state && (
                <div className="flex flex-col bg-white border border-gray-300 shadow-lg rounded-lg overflow-hidden w-full mb-4 z-30">
                    <div className="flex items-center p-2 bg-[#ffc107] text-white z-30">
                        <span className="text-lg text-white font-semibold">FikrSight</span>
                    </div>
                    ...
                    <div className="p-3 flex items-center border-t border-gray-300 bg-yellow-100">
                        <input
                            ...
                            className="flex-1 p-2 border border-gray-300 text-black rounded"
                            placeholder="Type a message..."
                        />
                        <button onClick={onSendButton} className="ml-2 bg-[#ffc107] text-gray-700 p-2 cursor-pointer rounded-lg text-sm sm:text-base md:text-sm">Send</button>
                    </div>
