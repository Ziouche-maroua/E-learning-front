...
const VS = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-5">
      <h1 className="text-3xl font-bold text-gray-800">Vector Space Visualization</h1>
      <svg ref={svgRef} className="border border-gray-300 mt-5"></svg>
      <div className="max-w-3xl text-left mt-5 font-sans">
        {/* Content */}
        <h2 className="text-2xl font-semibold text-gray-800">Definition of a Vector Space</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-4">Internal Law (Vector Addition)</h2>
        {/* Other content... */}
        <p className="text-gray-700 leading-relaxed mt-2">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 mt-4">External Law (Scalar Multiplication)</h2>
        <p className="text-gray-700 leading-relaxed mt-2">
