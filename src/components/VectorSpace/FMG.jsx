...
const FamilleGeneratrice = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-4 mb-8">
      <h2 className="text-3xl font-bold  mb-12 mt-4">Visualization of a Spanning Set of Vectors</h2>
      ...
      <div className=" max-w-3xl text-left  font-sans mt-8">
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <select  className="varback-color" onChange={(e) => setNumVectors(parseInt(e.target.value))} value={numVectors} style={{ padding: '5px', borderRadius: '5px', border: '1px solid lightgray' }}>
            <option  className="varback-color" value={2}>2</option>
            <option  className="varback-color" value={3}>3</option>
          </select>
        </div>
        ...
        <button onClick={handleSubmit} className= "mt-4 mb-4 font-bold  px-4 py-2 bg-yellow-200 text-black  rounded cursor-pointer border-none transition-all hover:border-2 hover:border-black">Check Spanning Set </button>
