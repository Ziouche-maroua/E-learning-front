...
const FamilleGeneratrice = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-4 mb-8">
      <h2 className='text-3xl md:text-3xl lg:text-4xl text-[#ffc107] font-bold mb-8 mt-4'>Visualization of a Spanning Set of Vectors</h2>
      
      <div className="max-w-full px-4 md:max-w-3xl text-left mt-5 font-sans">
      
        <p className=" bg-blue-200 p-4 rounded text-black font-bold mt-2 mb-4"> <b>Definition :</b> &nbsp;
      ...
      <div className="max-w-full bg-custom-green px-4 md:max-w-3xl text-left mt-5 font-sans  p-4 rounded  mb-12">
        <p className="font-bold text-black"> <b>Example :</b> &nbsp;
      ...
      <div className="max-w-full px-4 md:max-w-3xl text-left mt-5 font-sans mb-8">
        <p className="text-xl font-bold">In this visualization, the vectors provided span the entire ℝ² space, meaning any point in the plane can be reached using a combination of these vectors.</p>
      </div>

      <Mafs style={{ width: '100%', height: '400px' }}>
      ...
      <p className="font-bold mt-4">
        Choose the number of vectors and enter their components to verify if they form a spanning set:
      </p>

      <div className="mt-8">
        <label className="font-bold">Number of Vectors:</label>
        <select
          className="varback-color mb-3"
      ...
      <button
        ...
        className="mt-4 mb-4 font-bold px-4 py-2 bg-yellow-200 text-black rounded cursor-pointer border-none transition-all hover:border-2 hover:border-black"
      >
        Check Spanning Set
      </button>
      ...
      {isSpanning !== null && (
        <div style={{ marginTop: '20px', padding: '10px', borderRadius: '5px', backgroundColor: 'lightyellow' }}>
          <h4 className="font-bold text-2xl text-black mb-4">Explanation:</h4>
