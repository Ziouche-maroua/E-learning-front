    ...
    <div>
      ...
      <div className="container mx-auto px-4 pt-16 lg:pt-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className=" gradient-border  p-12 rounded-lg shadow-md border relative">
            <img
              src={vectorImage}
              alt="Vector Spaces"
              className="w-24 h-24 mx-auto"
            />
            <p className="text-xl font-semibold mt-4 varblue-text ">Vector Spaces</p>
          ...
          <div className=" gradient-border  p-12 rounded-lg shadow-md border relative">
            <img
              ...
              className="w-24 h-24 mx-auto"
            />
            <p className="text-xl font-semibold mt-4 varblue-text ">Linear Transformations</p>
            <div className="absolute bottom-0 right-0 mb-4 mr-4">
              <Link
                to="/chapter2"
                className=" text-blue-500 px-4 py-2 rounded-lg"
