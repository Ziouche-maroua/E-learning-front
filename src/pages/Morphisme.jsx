    ...
    <div className="h-screen flex flex-col">
      ...
      <div className="flex flex-1 pt-16">
        ...
        <div className="w-2/3 border border-blue-800 shadow-blue-800 p-4 mx-4 my-5">
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2">Endomorphism</h3>
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2">Isomorphism</h3>
            <p className="text-justify text-gray-700 leading-relaxed mb-4">
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-semibold mb-2">Automorphism</h3>
            <p className="text-justify text-gray-700 leading-relaxed mb-4">
